...
<head>
    ...
    <title>Cadastro de Servidores Terceirizados - UFCA</title>
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0-alpha1/dist/css/bootstrap.min.css" rel="stylesheet">
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.0.0-beta3/css/all.min.css">
    <style>
        body { background-color: #f8f9fa; }
        .navbar-brand img { height: 40px; }
        .page-section { display: none; margin-top: 20px; margin-bottom: 70px; }
        .page-section.active { display: block; }
        .card-header { background-color: #0056b3; color: white; }
        .btn-primary, .bg-primary { background-color: #0056b3 !important; border-color: #0056b3 !important; }
        .btn-primary:hover { background-color: #003d82 !important; border-color: #003d82 !important; }
        .table th { background-color: #e9ecef; }
        .stat-card { text-align: center; }
        .stat-card .card-body { font-size: 1.5rem; }
        .quick-access .btn { margin: 5px; }
        .format-example { background-color: #e9ecef; padding: 10px; border-radius: 5px; font-family: monospace; white-space: pre; }
        .card-header-filters { background-color: #6c757d; color: white; }
        .print-info { font-size: 0.8rem; color: #6c757d; }
        /* Estilos para visualização pública simulada */
        body.public-view-mode .navbar.bg-primary { display: none !important; } /* Esconde navbar principal */
        body.public-view-mode footer { display: none !important; } /* Esconde footer principal */
        .public-header { display: none; background-color: #0056b3; color: white; padding: 15px 0; margin-bottom: 20px; text-align: center; }
        body.public-view-mode .public-header { display: block; }
        .public-header img { height: 50px; margin-bottom: 10px; }
        body.public-view-mode .btn-toolbar .btn-outline-primary { display: none; } /* Esconde botão gerar link */
        body.public-view-mode #formFiltros button[type="submit"],
        body.public-view-mode #formFiltros button[type="reset"] { /* Pode-se optar por esconder ou desabilitar filtros na view publica */
            /* display: none; */
        }
...
<body>
    <!-- Cabeçalho para Visualização Pública (escondido por padrão) -->
    <div class="public-header">
        <!-- <img src="path/to/ufca_logo_branco.png" alt="UFCA Logo"> -->
        <h4>Universidade Federal do Cariri</h4>
        <h5>Relatório de Servidores Terceirizados</h5>
    </div>
...
Maria Oliveira[TAB]Porteiro[TAB]Crato[TAB]Centro de Ciências</div>
    ...
    <script>
        ...
        let todosServidores = [
            ...
            { id: 16, nome_completo: "CÍCERA SÔNIA GONÇALVES BEZERRA", funcao: "AUXILIAR ADMINISTRATIVO(A)", campus: "JUAZEIRO DO NORTE", setor: "SIBI - JUAZEIRO DO NROTE" },
            ...
            { id: 48, nome_completo: "ESPEDITO DUARTE OLIVEIRA", funcao: "AUXILIAR ADMINISTRATIVO(A)", campus: "JUAZEIRO DO NORTE", setor: "REITORIA - SEC. AÇOES AFIRMATIVAS" },
            ...
            { id: 80, nome_completo: "LAWANA FEITOSA DE MATOS", funcao: "AUXILIAR ADMINISTRATIVO(A)", campus: "JUAZEIRO DO NORTE", setor: "PROGRAD - DIPLOMAS" },
            ...
            { id: 112, nome_completo: "RENATA GONÇALVES GREGORIO", funcao: "AUXILIAR ADMINISTRATIVO(A)", campus: "JUAZEIRO DO NORTE", setor: "CCSA - MESTRADO DE BIBLIOTECONOMIA" },
            ...
            { id: 144, nome_completo: "FABIO VIEIRA VICENTE", funcao: "VIGILANTE - CE", campus: "JUAZEIRO DO NORTE", setor: "Lotação UFCA" },
            ...
            { id: 176, nome_completo: "MARCELINO DE SOUSA TIMOTEO", funcao: "VIGILANTE - CE", campus: "JUAZEIRO DO NORTE", setor: "Lotação UFCA" },
            ...
            { id: 208, nome_completo: "LILIAN ALVES DE OLIVEIRA", funcao: "COORDENADORA", campus: "JUAZEIRO DO NORTE", setor: "Lotação UFCA" },
            ...
            { id: 240, nome_completo: "LUIS FLAVIO LIMA ROQUE", funcao: "MOTORISTA", campus: "JUAZEIRO DO NORTE", setor: "Lotação UFCA" },
            ...
            { id: 272, nome_completo: "NELSON ANDRADE DUARTE", funcao: "SOLDADOR DE OBRAS", campus: "JUAZEIRO DO NORTE", setor: "Lotação UFCA" },
        ...
        function aplicarFiltrosFromParams(filters) {
        ...
        function preencherFormEdicao(id) {
            ...
            if (servidorParaEditar) {
                ...
                const campusOptions = Array.from(campusSelect.options).map(opt => opt.value);
